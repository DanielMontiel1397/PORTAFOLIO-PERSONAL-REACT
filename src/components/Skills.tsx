...
export default function Skills({nombre,logo} : SkillsProps) {
  return (
    <>
        <div data-aos="flip-left" className="flex flex-col items-center justify-center p-5 gap-5 rounded-3xl cursor-pointer transition-transform duration-1000 hover:rotate-360">
